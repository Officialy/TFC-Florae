...
public enum TFCFRockSoil
{
    ...
    ROCKIER_COMPACT_DIRT((self, variant, rock) -> new RockySoilBlock(Block.Properties.copy(Blocks.DIRT).mapColor( MapColor.DIRT).strength(0.9F).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCBlocks.ROCK_BLOCKS.get(rock).get(Rock.BlockType.LOOSE), TFCFBlocks.TFCFROCKSOIL.get(self.transform()).get(variant).get(rock), TFCFBlocks.TFCFROCKSOIL.get(ROCKY_COMPACT_DIRT).get(variant).get(rock), null, false),
                        (self, variant, rock) -> new RockySoilBlock(Block.Properties.copy(Blocks.DIRT).mapColor( MapColor.DIRT).strength(0.9F).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCBlocks.ROCK_BLOCKS.get(rock).get(Rock.BlockType.LOOSE), TFCFBlocks.TFCROCKSOIL.get(self.transform()).get(variant).get(rock), TFCFBlocks.TFCROCKSOIL.get(ROCKY_COMPACT_DIRT).get(variant).get(rock), null, false),
                        (self, variant, rock) -> new RockySoilBlock(Block.Properties.copy(Blocks.DIRT).mapColor( MapColor.DIRT).strength(0.9F).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.TFCF_ROCK_BLOCKS.get(rock).get(Rock.BlockType.LOOSE), TFCFBlocks.TFCFROCKSOIL2.get(self.transform()).get(variant).get(rock), TFCFBlocks.TFCFROCKSOIL2.get(ROCKY_COMPACT_DIRT).get(variant).get(rock), null, false),
                        (self, variant, rock) -> new RockySoilBlock(Block.Properties.copy(Blocks.DIRT).mapColor( MapColor.DIRT).strength(0.9F).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFBlocks.TFCF_ROCK_BLOCKS.get(rock).get(Rock.BlockType.LOOSE), TFCFBlocks.TFCROCKSOIL2.get(self.transform()).get(variant).get(rock), TFCFBlocks.TFCROCKSOIL2.get(ROCKY_COMPACT_DIRT).get(variant).get(rock), null, false)),
    ...
    DIRTIEST_STONE_TILES((self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.25f, 8).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFCF.get(variant), TFCFBlocks.TFCFSOIL.get(TFCFSoil.DIRT).get(variant), null, TFCFBlocks.ROCK_BLOCKS.get(rock).get(TFCFRock.TFCFBlockType.STONE_TILES), true),
                        (self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.25f, 8).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFC.get(variant), TFCBlocks.SOIL.get(SoilBlockType.DIRT).get(variant), null, TFCFBlocks.ROCK_BLOCKS.get(rock).get(TFCFRock.TFCFBlockType.STONE_TILES), true),
                        (self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.25f, 8).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFCF.get(variant), TFCFBlocks.TFCFSOIL.get(TFCFSoil.DIRT).get(variant), null, TFCFBlocks.TFCF_ROCKTYPE_BLOCKS.get(rock).get(TFCFRock.TFCFBlockType.STONE_TILES), true),
                        (self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.25f, 8).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFC.get(variant), TFCBlocks.SOIL.get(SoilBlockType.DIRT).get(variant), null, TFCFBlocks.TFCF_ROCKTYPE_BLOCKS.get(rock).get(TFCFRock.TFCFBlockType.STONE_TILES), true)),
    DIRTIER_STONE_TILES((self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.35f, 9).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFCF.get(variant), TFCFBlocks.TFCFROCKSOIL.get(self.transform()).get(variant).get(rock), null, null, false),
                        (self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.35f, 9).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFC.get(variant), TFCFBlocks.TFCROCKSOIL.get(self.transform()).get(variant).get(rock), null, null, false),
                        (self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.35f, 9).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFCF.get(variant), TFCFBlocks.TFCFROCKSOIL2.get(self.transform()).get(variant).get(rock), null, null, false),
                        (self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.35f, 9).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFC.get(variant), TFCFBlocks.TFCROCKSOIL2.get(self.transform()).get(variant).get(rock), null, null, false)),
    DIRTY_STONE_TILES((self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.5f, 10).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFCF.get(variant), TFCFBlocks.TFCFROCKSOIL.get(self.transform()).get(variant).get(rock), null, null, false),
                        (self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.5f, 10).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFC.get(variant), TFCFBlocks.TFCROCKSOIL.get(self.transform()).get(variant).get(rock), null, null, false),
                        (self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.5f, 10).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFCF.get(variant), TFCFBlocks.TFCFROCKSOIL2.get(self.transform()).get(variant).get(rock), null, null, false),
                        (self, variant, rock) -> new TFCFRockySoilBlock(Block.Properties.copy(Blocks.STONE).mapColor(MapColor.DIRT).strength(1.5f, 10).sound(SoundType.TUFF).requiresCorrectToolForDrops(), TFCFItems.SOIL_PILE_TFC.get(variant), TFCFBlocks.TFCROCKSOIL2.get(self.transform()).get(variant).get(rock), null, null, false));
    ...
    {
        return switch (this) {
            case DIRTY_STONE_TILES -> DIRTIER_STONE_TILES;
            case DIRTIER_STONE_TILES -> DIRTIEST_STONE_TILES;
            case DIRTIEST_STONE_TILES -> ROCKY_COMPACT_DIRT;
            case PEBBLE_COMPACT_DIRT -> ROCKY_COMPACT_DIRT;
            case ROCKY_COMPACT_DIRT -> ROCKIER_COMPACT_DIRT;
            case ROCKIER_COMPACT_DIRT -> ROCKIEST_COMPACT_DIRT;
            default -> this;
        };
    }
}
