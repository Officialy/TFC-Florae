...
import tfcflorae.common.entities.ai.TadpoleAi;
...
public class Tadpole extends AbstractFish
{
    ...
    {
        return TadpoleAi.create(this.brainProvider().makeBrain(dynamic));
    }
    ...
    {
        return TFCFSounds.TADPOLE_FLOP.get();
    }
    ...
    {
        return TFCFSounds.TADPOLE.hurt().get();
    }

    @Override @Nullable
    protected SoundEvent getDeathSound()
    {
        return TFCFSounds.TADPOLE.death().get();
    }
    ...
    {
        return new ItemStack(TFCFItems.TADPOLE_BUCKET.get());
    }

    @Override
    public SoundEvent getPickupSound()
    {
        return TFCFSounds.BUCKED_FILL_TADPOLE.get();
    }
    ...
    private void growUp()
    {
        if (this.level() instanceof ServerLevel server)
        {
            ...
            this.playSound(TFCFSounds.TADPOLE_GROW_UP.get(), 0.15F, 1.0F);
