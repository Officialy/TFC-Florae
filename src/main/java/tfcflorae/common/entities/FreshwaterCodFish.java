...
public class FreshwaterCodFish extends Cod implements AquaticMob
{
    private final TFCFSounds.FishSound sound;
    private final Supplier<? extends Item> bucket;

    public FreshwaterCodFish(EntityType<? extends FreshwaterCodFish> type, Level level, TFCFSounds.FishSound sound, Supplier<? extends Item> bucket)
    {
        super(type, level);
        this.sound = sound;
        this.bucket = bucket;
