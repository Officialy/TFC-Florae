...
public enum PlateBiomeLayer implements CenterTransformLayer
{
    ...
    private static final int[] OCEANIC_BIOMES = {DEEP_OCEAN, DEEP_OCEAN, DEEP_OCEAN, PELAGIC_ZONE};
    private static final int[] OCEAN_CONTINENT_CONVERGING = {DEEP_OCEAN_TRENCH, DEEP_OCEAN_TRENCH, SEAMOUNTS, GUYOTS};
