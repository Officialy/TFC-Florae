...
public class GlacierFeature extends TFCIcebergFeature
{
    public GlacierFeature(Codec<BlockStateConfiguration> codec)
    {
        super(codec);
    }
    ...
    public int getEllipseC(int p_66019_, int p_66020_, int p_66021_)
    {
        int i = p_66021_;
    ...
    public double signedDistanceEllipse(int p_66023_, int p_66024_, BlockPos p_66025_, int p_66026_, int p_66027_, double p_66028_)
    {
    ...
    public int heightDependentRadiusEllipse(int p_66110_, int p_66111_, int p_66112_)
    {
        float f = 1.0F;
    ...
    public static boolean isIcebergState(BlockState p_159886_)
    {
