...
public class RockPillarFeature extends Feature<RockPillarConfig>
{
    ...
    private void placeBaseHangOff(LevelAccessor level, RandomSource random, BlockPos pos, List<BlockState> states)
    {
        Supplier<BlockState> state;
        if (states.size() == 1)
        {
    ...
    private boolean placeHangOff(LevelAccessor level, RandomSource random, BlockPos pos, List<BlockState> states)
    {
        Supplier<BlockState> state;
        if (states.size() == 1)
        {
