...
//    @Shadow public static final int VOLCANIC_OCEANIC_MOUNTAIN_RIVER;
    ...
    @Unique
    private static final int GRASSLANDS;
    @Unique
    private static final int WETLANDS;
    @Unique
    private static final int MARSHES;
    @Unique
    private static final int SWAMPS;
    @Unique
    private static final int MANGROVES;
    @Unique
    private static final int PUY_MOUNTAINS;
    @Unique
    private static final int BRYCE_CANYONS;
    @Unique
    private static final int MESA_HILLS;
    @Unique
    private static final int BADLANDS_PLATEAU;
    @Unique
    private static final int CANYON_RIVER;
    @Unique
    private static final int ALPINE_MOUNTAIN_RIVER;
    @Unique
    private static final int ALPINE_MOUNTAINS;
    @Unique
    private static final int ALPINE_HIGHLANDS;
    @Unique
    private static final int ROLLING_HIGHLANDS;
    @Unique
    private static final int CALDERAS;
    @Unique
    private static final int GRAVEL_SHORE;
    @Unique
    private static final int THERMAL_CANYONS;
    @Unique
    private static final int MESA_PLATEAU;
    @Unique
    private static final int PEAT_BOG;
    @Unique
    private static final int RIVERBANK;
    @Unique
    private static final int RIVER_EDGE;
    @Unique
    private static final int CHASMS;
    @Unique
    private static final int PLATEAU_CLIFFS;
    @Unique
    private static final int STEPPES;
    @Unique
    private static final int SHRUBLANDS;
    @Unique
    private static final int MOORLANDS;
    @Unique
    private static final int MISTY_PEAKS;
    @Unique
    private static final int COASTAL_CLIFFS;
    @Unique
    private static final int SHORE_DUNES;
    @Unique
    private static final int VINICUNCA_MOUNTAINS;
    @Unique
    private static final int NEAR_SHORE;
    @Unique
    private static final int LAKE_SHORE;
    @Unique
    private static final int PELAGIC_ZONE;
    @Unique
    private static final int SEAMOUNTS;
    @Unique
    private static final int GUYOTS;
    @Unique
    private static final int ATOLL;
    @Unique
    private static final int BARRIER_REEF;
    @Unique
    private static final int LAGOON;
    @Unique
    private static final int SAWTOOTH_CLIFFS;
    @Unique
    private static final int TABLELANDS;
    @Unique
    private static final int PITLANDS;
    @Unique
    private static final int FRACTURED_MISTY_PEAKS;
...
//    @Shadow public static final int OCEAN_REEF_MARKER;
    @Unique
    private static final int CALDERA_MARKER;
    @Unique
    private static final int PUY_MOUNTAINS_MARKER;
    @Unique
    private static final int MESA_PLATEAU_MARKER;
    @Unique
    private static final int PELAGIC_ZONE_MARKER;
    @Unique
    private static final int SEAMOUNTS_MARKER;
    @Unique
    private static final int GUYOTS_MARKER;
    @Unique
    private static final int ATOLL_MARKER;
    @Unique
    private static final int BARRIER_REEF_MARKER;
    @Unique
    private static final int BARRIER_REEF_SHORE_MARKER;
    @Unique
    private static final int BARRIER_REEF_OCEAN_MARKER;
    @Unique
    private static final int LAGOON_MARKER;
...
//        OCEAN_REEF_MARKER = register();
        CALDERA_MARKER = register(() -> null);
        PUY_MOUNTAINS_MARKER = register(() -> null);
        MESA_PLATEAU_MARKER = register(() -> null);
        PELAGIC_ZONE_MARKER = register(() -> null);
        SEAMOUNTS_MARKER = register(() -> null);
        GUYOTS_MARKER = register(() -> null);
        ATOLL_MARKER = register(() -> null);
        BARRIER_REEF_MARKER = register(() -> null);
        BARRIER_REEF_SHORE_MARKER = register(() -> null);
        BARRIER_REEF_OCEAN_MARKER = register(() -> null);
        LAGOON_MARKER = register(() -> null);
    }
...
/*
    ...
    /* && value != RIVERBANK && value != RIVER_EDGE *//*
;
    }
...
*/
    ...
    public static int register(Supplier<BiomeExtension> variants) {
        ...
        if (index >= BIOME_LAYERS.length) {
            ...
            BIOME_LAYERS[index] = Helpers.BOOTSTRAP_ENVIRONMENT ? null : (BiomeExtension) variants.get();
            return index;
        }
    }
}
