...
# Update path to be consistent with generate_textures.py
current_dir = os.path.dirname(os.path.abspath(__file__))
project_root = os.path.abspath(os.path.join(current_dir, ".."))
SRC = os.path.join(project_root, 'src/main/resources/assets/tfc/textures/colormap/')

# Print path for debugging
print(f"Using colormap path: {SRC}")
